        ...
        completion = client.beta.chat.completions.parse(
            ...
            messages=[
                {"role": "system", "content": (
                    ...
                    "Your task is to critically read through documents and find three different newsworthy storylines that are relevant and impactful"
                    "Dont use technical jargon, only simple terms that a general audience can understand."
